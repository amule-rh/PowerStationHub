(function(){
  ...
  if(nav){
    ...
    if(menu && !menu.querySelector('[data-solar-autonomy-link]')){ const a=document.createElement('a'); a.href=lang==='es'?'/es/autonomia-energetica/':'/en/energy-independence/'; a.textContent=lang==='es'?'Autonomía solar':'Energy independence'; a.dataset.solarAutonomyLink='1'; menu.insertBefore(a, menu.querySelector('.lang')||null); }
  ...
  document.querySelectorAll('.footer').forEach(footer=>{
    ...
    const p=lang==='es'?{
      ...
      root:'/en/',about:'/en/about/',method:'/en/methodology/',contact:'/en/contact/',products:'/en/products/',compare:'/en/comparator/',calc:'/en/power-calculator/',comparisons:'/en/comparisons/',best:'/en/best-2026/',guides:'/en/guides/',solar:'/en/energy-independence/',affiliate:'/en/affiliate-disclosure/',privacy:'/en/privacy/',cookies:'/en/cookies/',disclosure:'/en/affiliate-disclosure/',
